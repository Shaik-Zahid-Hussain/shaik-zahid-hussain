  ...
  const internships = [
    {
      ...
      location: 'Remote',
      description:
        'Developed responsive web applications using React.js and collaborated with cross-functional teams to deliver high-quality user interfaces.',
      achievements: [
    ...
    },
    {
      ...
      location: 'Remote',
      description:
        'Worked on Python-based projects, developed automation scripts, and contributed to backend development using modern Python frameworks.',
      achievements: [
